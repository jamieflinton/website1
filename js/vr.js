...
var Grid = /** @class */ (function () {
    ...
    Grid.prototype.generateGrid = function () {
        ...
        this.color = new THREE.Color(0xfffffff);
    ...
    Grid.prototype.showWhiteGrid = function () {
        TweenLite.to(this.uniProgress, 2.0, { value: 0.0, easing: Power2.easeInOut, onStart: function () {
    ...
    Grid.prototype.update = function (_props) {
        if (typeof _props != "undefined" && _props.speed > 0) {
            this.rippleGen.newRippleImpact(_props.speed / 24);
